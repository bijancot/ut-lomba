<header class="header px-5 py-3 d-flex flex-column flex-md-row justify-content-between align-items-center">
    ...
    <?php } else { ?>
        <div class="d-flex flex-row align-items-center h-100">
            <a href="<?= site_url('sign-up') ?>" class="links font-w-600 <?= uri_string() == 'register' ? 'active' : '' ?>">Daftar</a>
            <span class="spacer"></span>
            <a href="<?= site_url('sign-in') ?>" class="links font-w-600 <?= uri_string() == 'login' ? 'active' : '' ?>">Masuk</a>
        </div>
        <!-- <div class="d-flex ms-n5 flex-row align-items-center h-100">
