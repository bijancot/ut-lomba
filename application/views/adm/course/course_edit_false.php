            ...
            <form action="<?= site_url('admin/course/update')?>" enctype='multipart/form-data' method="post">
                <div class="form-group">
                    ...
                    <div id="boxImg" class="text-center mt-3 mb-3 p-3" style="border: 1px solid #ddd;border-radius: 10px;cursor: pointer;">
                        <img style="max-width: 250px;" id="blah" class="" src="<?= $course->IMG_COURSE ?>" />
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="<?= $course->NAMA_COURSE ?>" name="nama" id="" required>
                </div>
                <div class="form-group">
                    <label>Deskripsi</label><span class="text-warning">*</span>
                    <textarea class="form-control" type="text" name="deskripsi" id="" required><?= $course->DESKRIPSI_COURSE ?></textarea>
                </div>
