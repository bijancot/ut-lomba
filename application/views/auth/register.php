            ...
            <div class="w-50 bg-white b-radius-28 position-absolute start-0 bottom-0 top-0">
                <section class="form-section px-5 h-100 d-flex flex-column justify-content-center align-items-start">
                    ...
                    <div class="position-relative overflow-hidden d-flex align-items-center w-100 h-100">
                        ...
                        <div class="register-slide active position-absolute" id="register-step-1">
                            ...
                            <button type="submit" class="auth-btn mt-3" id="goToStep2">Selanjutnya</button>
                            <p class="text-center w-100 mt-3">Sudah punya akun ? <a href="<?= site_url('/login')?>" class="font-w-600">Masuk</a></p>
                        </div>

                        <div class="register-slide position-absolute" id="register-step-2">
                            <div class="d-flex align-items-center w-100 mb-5">
                                <button class="border-0 bg-transparent" id="goToStep1"><span class="iconify me-3 h4 mb-0" data-icon="akar-icons:chevron-left"></span></button>
                                <p class="brand mb-0">Daftar</p>
