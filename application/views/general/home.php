        ...
        <div class="d-flex flex-row ps-11 mt-11">
            <div class="w-100 row pt-5">
                <div class="col-12 col-lg-6 col-xl-5">
                    <div class="row row-cols-2 g-0 grid-box">
                        ...
                        <div class="col box-black overflow-hidden">
                            <span data-aos="fade-left" data-aos-duration="1500" data-aos-delay="100">46</span> Universitas
                        </div>
                        <div class="col box-transparent overflow-hidden" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                            <span>223</span> Materi
                        </div>
                ...
                <div class="col-12 col-lg-6 pe-5">
                    <p class="fs-55 t1 font-w-400">Apa itu</p>
                    <p class="fs-55 t2 font-w-700">UT NGL</p>
                    <p class="fs-5 pe-5 color-secondary-dark">UT Next Gen Leader merupakan program yang digunakan untuk menyediakan training pengembangan diri kepada millenials dan gen Z yang memiliki potensi dan minat yang tinggi.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="container-xxl">
        <div class="row row-cols-2">
            ...
            <div class="col p-5">
                ...
                <p class="fs-5 pe-5 color-secondary-dark">Platform yang Mudah Digunakan Untuk Meningkat Skill dan Minat Yang Disukai</p>
                <p class="fs-5 pe-5 color-secondary-dark">Mendapatkan Tutor Dari Expertise Dan Berkesempatan Menjadi Bagian dari United Tractor</p>
            </div>
        </div>
    </div>
                ...
                <div class="col p-5 d-flex justify-content-start align-items-center">
                    <div class="d-flex flex-column fs-4">
                        <div class="position-relative border-l-primary ps-5 pb-4">
                            ...
                            <p class="font-w-600" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="50" data-aos-once="true">Pendaftaran</p>
                        </div>
                        <div class="position-relative border-l-primary ps-5 pb-4">
                            <span class="primary-dot"></span>
                        ...
                        <div class="position-relative border-l-primary t ps-5 pb-4">
                            ...
                            <p class="font-w-600" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Seleksi</p>
                        </div>
                    </div>
                </div>
            </div>
